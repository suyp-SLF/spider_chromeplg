...
$('#questionin').click(() => {
	...
	sendMessageToContentScript({cmd:'questionin',url:url}, (response) => {
		if(response) alert('收到来自content-script的回复：'+response);
	});
});
...
$('#questionsearch').click(() => {
	var url = $('#serverurl').val();
	sendMessageToContentScript({cmd:'questionsearch',url:url}, (response) => {
		if(response) alert('收到来自content-script的回复：'+response);
	});
});
...
$('#resulton').click(() => {
	var url = $('#serverurl').val();
	sendMessageToContentScript({cmd:'resulton',url:url}, (response) => {
		if(response) alert('收到来自content-script的回复：'+response);
	});
});
...
$('#resultoff').click(() => {
	var url = $('#serverurl').val();
	sendMessageToContentScript({cmd:'resultoff',url:url}, (response) => {
		if(response) alert('收到来自content-script的回复：'+response);
	});
});
...
$('#testserver').click(() => {
	var url = $('#serverurl').val();
	sendMessageToContentScript({cmd:'testserver',url:url}, (response) => {
		if(response) alert('收到来自content-script的回复：'+response);
	});
});
